...
function AllProductsTable() {
  ...
  useEffect(() => {
    axios.get("http://127.0.0.1:8080/api/product/get/all").then((response) => {
  ...
  return (
    <>
                          ...
                          <tr key={product.id}>
                            ...
                            <td>
                              <Button
                                role="button"
                                variant="success"
                                onClick={() => setEditShowDetailsModal(product)}
                              >
                                Details
                              </Button>
                            </td>
      ...
      <CreateProduct show={showCreateModal} handleCloseCreate={handleCloseCreate} />
      <ProductId.Provider value={productId}>
        <EditAllModal show={show} handleClose={handleClose} />
      </ProductId.Provider>
      <ProductId.Provider value={productId}>
        <DetailsModal show={showDetailsModal} handleCloseDetailsModal={handleCloseDetailsModal} />
      </ProductId.Provider>
      <ProductId.Provider value={productId}>
        <DeleteModal show={showDelete} handleDeleteClose={handleDeleteClose} />
      </ProductId.Provider>
    </>
  );
}
